...
class CorporatorAnnouncementsScreen
    extends ConsumerStatefulWidget {
  const CorporatorAnnouncementsScreen({super.key});

  @override
  ConsumerState<CorporatorAnnouncementsScreen> createState() =>
      _CorporatorAnnouncementsScreenState();
}

class _CorporatorAnnouncementsScreenState
    extends ConsumerState<CorporatorAnnouncementsScreen> {
